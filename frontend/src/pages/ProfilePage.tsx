...
import { User, Mail, Phone, MapPin, Calendar, Award, CreditCard as Edit3, Save, X, Plus, Trash2 } from 'lucide-react';
            ...
            <div className="flex justify-between items-start">
              <div className="flex items-center">
                ...
                <div className="ml-6">
                  ...
                  <p className="text-primary-100">{user?.role?.replace('-', ' ').charAt(0).toUpperCase() + user?.role?.slice(1).replace('-', ' ')}</p>
