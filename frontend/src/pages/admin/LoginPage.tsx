...
function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-700 to-indigo-700 flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full">
        <div className="text-center text-white">
          <Shield className="mx-auto h-12 w-12 text-white mb-4" />
          <h2 className="text-2xl font-semibold">Admin Sign In</h2>
          <p className="mt-2 text-gray-200">Administrator access to Global Skills Bridge</p>
        </div>
