...
import { Award, CheckCircle, Clock, AlertCircle, Upload, Shield, Blocks as Blockchain, Plus, Download, Eye, Globe } from 'lucide-react';
              ...
              <form onSubmit={handleAddSkill} className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setNewSkill(prev => ({ ...prev, level: e.target.value as 'Basic' | 'Intermediate' | 'Advanced' | 'Expert' }))}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                  >
